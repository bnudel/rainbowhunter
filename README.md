...
- **Color-coded time slider.** The slider track is tinted by the *average* rainbow
  chance across the whole searched area at each hour, so you can see at a glance which
  hours are worth chasing before you even move the handle (violet = quiet, red = prime).
